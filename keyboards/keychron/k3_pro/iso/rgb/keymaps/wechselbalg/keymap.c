...
[QWERTY] = LAYOUT_iso_85(
     ...
     KC_TAB,   DE_Q,     DE_W,     DE_E,     DE_R,     DE_T,     DE_Z,     DE_U,     DE_I,     DE_O,     DE_P,     DE_UE,    DE_PLUS,  KC_ENT,             KC_HOME,
     MO(SYM),  DE_A,     DE_S,     DE_D,     DE_F,     DE_G,     DE_H,     DE_J,     DE_K,     DE_L,     DE_OE,    N_SY_AE,  N_SY_HS,                      KC_END,
     KC_LSFT,  MO(NUM),  DE_Y,     DE_X,     DE_C,     DE_V,     DE_B,     DE_N,     DE_M,     DE_COMM,  DE_DOT,   DE_MINS,  KC_RSFT,            KC_UP,    MO(FN),
     KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                                 MO(NAV),  KC_RALT, KC_RCTL,   KC_LEFT,  KC_DOWN,  KC_RGHT),
