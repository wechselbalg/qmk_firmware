...
#define N2_RAQO        RALT(DE_Y)      // »   RALT(DE_Y)
#define N2_LAQO        RALT(DE_X)      // «   RALT(DE_X)
#define N2__DLR        DE_DLR          // $
#define N2__EUR        ALGR(DE_E)      // €
#define N2_LODQ        RALT(DE_V)      // „   RALT(DE_V)
#define N2_L_DQ        RALT(DE_B)      // “   RALT(DE_B)
#define N2_R_DQ        RALT(DE_N)      // ”   RALT(DE_N)
#define N2_C_SS        RSA(DE_S)       // ẞ   RSA(DE_S)
