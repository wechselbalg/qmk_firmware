...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    //  QWERTY
    [_BASE] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_CALC,          KC_MSTP,
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,          KC_DEL,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,                   KC_HOME,
        MO(_M3), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, MO(_M4), KC_ENT,           KC_END,
        KC_LSFTCAPSWIN, MO(_M4), KC_Z, KC_X, KC_C,   KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_UP,   KC_APP,
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             MO(_M3), MO(_FN),KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    //  SYMBOL (Symbo layer - NEO layer 3)
    [_M3] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        KC_NO,ALGR(KC_1), DE_SUP2, DE_SUP3, DE_EURO, KC_NO  , KC_NO  , KC_NO  , KC_COMM, KC_NO  , KC_NO  , KC_NO  , KC_NO  , _______,          _______,
        _______, KC_NO  , DE_UNDS, DE_LBRC, DE_RBRC, DE_CIRC, DE_EXLM, DE_LABK, DE_RABK, DE_EQL , DE_AMPR, KC_NO  , KC_NO  ,                   _______,
    ...
    //  (Numpad & Navigation layer - NEO layer 4)
    [_M4] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
    ...
    //  FUNC (Function layer)
    [_FN] = LAYOUT(
        QK_BOOT, KC_MYCM, KC_WHOM, KC_CALC, KC_MSEL, KC_MPRV, KC_MNXT, KC_MPLY, KC_MSTP, KC_MUTE, KC_VOLD, KC_VOLU, _______, KC_INS,           RGB_TOG,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, RGB_VAI, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______, _______,                   KC_PGUP,
        KC_CAPS, _______, RGB_VAD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_PGDN,
    ...
    [_COLEMAK] = LAYOUT(
        ...
        TT(_M3), KC_A, KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, KC_NUHS, KC_ENT,           KC_PGDN,
    ...
    void rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
        ...
        case _FN:  // on Fn layer select what the encoder does when pressed
        ...
        case _M4:
            ...
            rgb_matrix_set_color(LED_R4, RGB_BLUE);
            rgb_matrix_set_color(LED_R5, RGB_BLUE);
